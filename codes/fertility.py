...
datacube = connection.load_collection(
    ...
    bands=["B02", "B04", "B08", "B11"],  # Bandas: Blue (B02), Red (B04), NIR (B08), SWIR (B11)
    max_cloud_cover=85,
)
